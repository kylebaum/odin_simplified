class MessagesController < ApplicationController
  def index
    ...
    @messages = @q.result(:distinct => true).includes(:property).page(params[:page]).per(10)
  ...
  def create
    ...
    @message.sender_type = params[:sender_type]
    @message.recipient_type = params[:recipient_type]
